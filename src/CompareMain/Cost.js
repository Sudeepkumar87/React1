  ...
  return (
    <section className={"container"}>
      <div className={classes.mainCont}>
        ...
        <div>
          <p className={classes.mainPara}>Your Energy consumption</p>
        </div>
        <div className={classes.mainGrid}>
          ...
          <div>
            ...
            <div className={classes.intertMain}>
              <div className={classes.mainColor}>
                <p className={classes.innerWhite}>Annual Electricity Cost</p>
                <img src={White} className={classes.whaiteMain} />
              </div>
              <div className={classes.innerOut}>
                <p className={classes.outerMain}>£</p>
                <p className={classes.outerMain}>1250</p>
              </div>
            </div>
          </div>
        </div>
